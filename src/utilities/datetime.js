...
export const getDateStart = (date = new Date()) => {
    date.setHours(0, 0, 0, 0);
    return date;
};

export const getDateEnd = (date = new Date()) => {
...
export const parseDateTimeToNumber = (date) => {
    const month = date.getMonth() + 1;
    const day = date.getDate();
    const year = date.getFullYear();
...
export const  getFormattedWithDate = (date, format = 'd (DD/MM/YYYY)') => {
...
export const addHours = (time, hours = 0) => {
